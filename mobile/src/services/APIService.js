...
class APIService {
  ...
  async getSocialDiscussions(params = {}) {
    try {
      const queryString = new URLSearchParams(params).toString();
      const response = await this.axiosInstance.get(`/learn/social/discussions?${queryString}`);
      return { success: true, data: response.data };
    } catch (error) {
  ...
  async getStudyGroups(params = {}) {
    try {
      const queryString = new URLSearchParams(params).toString();
      const response = await this.axiosInstance.get(`/learn/social/groups?${queryString}`);
      return { success: true, data: response.data };
    } catch (error) {
      return { success: false, error: error.response?.data?.message || 'Failed to fetch study groups' };
    }
  }

  async getProgressShares(params = {}) {
    try {
      const queryString = new URLSearchParams(params).toString();
      const response = await this.axiosInstance.get(`/learn/social/shares?${queryString}`);
      return { success: true, data: response.data };
    } catch (error) {
      return { success: false, error: error.response?.data?.message || 'Failed to fetch progress shares' };
    }
  }
  ...
  async getLearningAnalytics(params = {}) {
    try {
      const queryString = new URLSearchParams(params).toString();
      const response = await this.axiosInstance.get(`/learn/analytics?${queryString}`);
      return { success: true, data: response.data };
    } catch (error) {
      return { success: false, error: error.response?.data?.message || 'Failed to fetch analytics data' };
    }
  }
  ...
  async getPerformanceMetrics() {
    try {
      const response = await this.axiosInstance.get('/learn/performance/metrics');
      return { success: true, data: response.data };
    } catch (error) {
